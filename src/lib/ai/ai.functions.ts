...
- trajectory: ordene da experiência mais recente para a mais antiga. Inclua TODAS as experiências profissionais presentes no currículo, sem excluir nenhuma. Mantenha o MESMO formato detalhado para TODAS: traga scope (resumo do escopo) e até 6 bullets detalhados no total somando responsibilities + deliveries + results. Sempre que o material tiver informações suficientes, preencha os 6 bullets. Cada bullet deve descrever de forma completa as atividades realizadas na empresa, com até 50 palavras: responsabilidades, processos conduzidos, projetos, áreas/clientes atendidos, resultados obtidos, e plataformas, sistemas e ferramentas utilizadas — mas SOMENTE quando essas informações estiverem disponíveis nos materiais. Nunca invente nada: se a informação não existir, apenas omita. Cada bullet DEVE terminar com ponto final (.).
- PADRÃO DE ESCRITA DAS EXPERIÊNCIAS (obrigatório em responsibilities, deliveries, results e scope): linguagem profissional, técnica e objetiva, própria de currículo. Escreva cada bullet começando por SUBSTANTIVO DE AÇÃO (forma nominal), nunca por verbo conjugado.
  PROIBIDO iniciar bullets com verbos conjugados como: "Realiza", "Realizou", "Organiza", "Presta", "Emite", "Contribui", "Faz", "Auxilia", "Atende", "Controla", "Acompanha", "Elabora", "Executa", "Analisa", "Desenvolve", "Planeja", "Gerencia" (e qualquer outra forma verbal conjugada).
  PREFIRA iniciar com: Gestão, Estruturação, Elaboração, Emissão, Organização, Controle, Acompanhamento, Planejamento, Desenvolvimento, Execução, Análise, Suporte, Atendimento, Coordenação, Implementação, Monitoramento, Negociação.
  Exemplos de conversão:
  ANTES: "Presta atendimento ao público presencial, por telefone, e-mail e WhatsApp." DEPOIS: "Atendimento ao público por canais presenciais e digitais, incluindo telefone, e-mail e WhatsApp."
  ANTES: "Organiza agendas dos profissionais da clínica, confirmando consultas, avaliações e reuniões." DEPOIS: "Gestão das agendas dos profissionais da clínica, incluindo organização e confirmação de consultas, avaliações e reuniões."
  ANTES: "Emite notas fiscais e realiza o controle rigoroso de pagamentos e fluxos financeiros." DEPOIS: "Emissão de notas fiscais, controle de pagamentos e acompanhamento dos fluxos financeiros."
  Sem adjetivos de valor ("rigoroso", "excelente", "estratégico") e sem 1ª pessoa. Não invente responsabilidades e NUNCA eleve artificialmente a senioridade da experiência (não transforme execução em liderança, nem apoio em gestão de área): apenas melhore a forma de escrever o que consta nos materiais.
